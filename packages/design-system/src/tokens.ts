...
export const colorPrimitives = {
  gray: {
    1: '#ffffff', 2: '#f8f8f8', 3: '#f0f0f0', 4: '#e5e5e5',
    5: '#d4d4d4', 6: '#a3a3a3', 7: '#737373', 8: '#525252',
    9: '#2f2f2f', 10: '#171717',
  },
  orange: {
    1: '#fff7ed', 2: '#ffedd5', 3: '#fed7aa', 4: '#fdb87a',
    5: '#fb923c', 6: '#f7823a', 7: '#f66b26', 8: '#e65a1a',
    9: '#c2410b', 10: '#7a2b08',
  },
  green: {
    1: '#f0fdf4', 2: '#dcfce7', 3: '#bbf7d0', 4: '#86efac',
    5: '#4ade80', 6: '#4caf50', 7: '#16a34a', 8: '#15803d',
    9: '#166534', 10: '#14532d',
  },
  red: {
    1: '#fff1f2', 2: '#fee2e2', 3: '#fecaca', 4: '#fca5a5',
  ...
  brown: {
    1: '#fffaf6', 2: '#fff5ec', 3: '#f6e9df', 4: '#ecdccf',
    5: '#e1cfbf', 6: '#d3c3b3', 7: '#b9a596', 8: '#8f7b69',
    9: '#6b5642', 10: '#4a392c',
  },
} as const;
