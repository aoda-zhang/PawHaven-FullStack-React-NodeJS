export const MENU_CLASSES = {
  ...
  login:
    'px-3 py-2 rounded-lg bg-primary text-primary-foreground font-semibold shadow-sm flex items-center justify-center gap-1.5 cursor-pointer transition-colors hover:bg-primary/90',
} as const;
