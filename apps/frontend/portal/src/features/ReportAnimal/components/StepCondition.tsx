  ...
  return (
    <div>
      <h2 className="text-foreground mb-1 text-lg font-semibold">
        {t('reportAnimal.wizard.step3_title')}
      </h2>
      <p className="text-muted-foreground mb-5 text-sm">
        {t('reportAnimal.wizard.step3_subtitle')}
      </p>
      <div className="mb-4">
        <label className="text-foreground mb-2 block text-sm font-medium">
          {t('reportAnimal.wizard.step3_color_label')}
        </label>
        <input
          type="text"
          value={coatColor}
      ...
      <div className="mb-4">
        <label className="text-foreground mb-2 block text-sm font-medium">
          {t('reportAnimal.wizard.step3_size_label')}
        </label>
        <div className="flex gap-2">
          {SIZES.map((s) => (
            ...
            >
              {t(`reportAnimal.wizard.step3_size_${s.value}`)}
            </button>
          ))}
        </div>
      </div>
      <div>
        <label className="text-foreground mb-2 block text-sm font-medium">
          {t('reportAnimal.wizard.step3_behavior_label')}
        </label>
          ...
          {BEHAVIORS.map((b) => (
            ...
            >
              ...
              <span className="text-foreground text-sm">
                {t(`reportAnimal.wizard.step3_behavior_${b.value}`)}
              </span>
            </label>
          ))}
        </div>
