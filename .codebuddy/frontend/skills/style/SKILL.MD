...
Only use inline styles when the value is truly dynamic and cannot be represented with Tailwind utilities or design tokens.
...
- [ ] No hardcoded typography — font tokens used (`font-heading`, `text-xl`, etc.)
