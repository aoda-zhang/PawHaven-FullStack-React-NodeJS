...
6. **Implement and review.** Delegate per-workstream to subagents with named data shapes and success criteria. Review every diff yourself; write your own summary. Guard at the boundary per **principle-boundary-discipline**.
